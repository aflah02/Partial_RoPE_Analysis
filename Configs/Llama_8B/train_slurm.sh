...
bash /dais/fs/scratch/afkhan/RoPE_Pct/MPCDF_8B_FW_Runs_Seq_Len_2048/0_Pct/write_hostfile.sh # [Ensure this path is correct]
# Tell DeepSpeed where to find our generated hostfile
export DLTS_HOSTFILE=/dais/fs/scratch/afkhan/RoPE_Pct/MPCDF_8B_FW_Runs_Seq_Len_2048/0_Pct/hostfiles/hosts_$SLURM_JOBID # [Ensure this path matches the one generated by write_hostfile.sh]
